...
```bash
/Users/a0000/sdk/go1.22.0/bin/go test ./... -count=1
/Users/a0000/sdk/go1.22.0/bin/go test -race ./... -count=1
/Users/a0000/sdk/go1.22.0/bin/go vet ./...
```
...
/Users/a0000/sdk/go1.22.0/bin/go test -count=1 -run 'TestRedis(Single|Cluster)Integration' -v ./...
```
